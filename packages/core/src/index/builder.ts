import type { ToolDefinition, IndexedTool, JsonSchema } from '../types/index.js';
...
const STOP_WORDS = new Set([
  ...
  'you', 'your', 'can', 'could', 'would', 'should', 'may', 'might',
  'must', 'shall', 'into', 'if', 'then', 'than', 'so', 'no', 'not',
  'only', 'own', 'same', 'such', 'too', 'very', 'just', 'but', 'also',
]);
